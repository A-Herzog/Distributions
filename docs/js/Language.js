...
lang.distributions.infoDiagramCentralLimitTheoremInfo="Für i.i.d. verteilte Zufallsvariablen <i>X</i><sub>1</sub>, <i>X</i><sub>2</sub>, ... mit gemeinsamem Erwartungswert &mu; und Varianz &sigma;<sup>2</sup> strebt <math><mrow><msub><mi>Y</mi><mi>n</mi></msub><mo>=</mo><mfrac><mn>1</mn><msqrt><mi>n</mi></msqrt></mfrac><munderover><mo>&sum;</mo><mrow><mi>i</mi><mo>=</mo><mn>1</mn></mrow><mo>&infin;</mo></munderover><mfrac><mrow><msub><mn>x</mn><mn>i</mn></msub><mo>-</mo><mn>&mu;</mn></mrow><mn>&sigma;</mn></mfrac></math> für <i>n</i>&rarr;&infin; verteilungsmäßig gegen die Standardnormalverteilung <i>N</i>(0,1). Zur Veranschaulichung werden die <i>X<sub>i</sub></i> durch simulierte Zufallszahlen zur ausgewählten Verteilung ersetzt. Die relativen Häufigkeiten der dazu ermittelten <i>Y<sub>n</sub></i> Werte werden angezeigt, sie nähern sich rasch der Dichte von <i>N</i>(0,1)<(i>) an.";
...
lang.distributions.infoDiagramCentralLimitTheoremInfo="For i.i.d. distributed random variables <i>X</i><sub>1</sub>, <i>X</i><sub>2</sub>, ... with common expected value &mu; and variance &sigma;<sup>2</sup> the partial sum <math><mrow><msub><mi>Y</mi><mi>n</mi></msub><mo>=</mo><mfrac><mn>1</mn><msqrt><mi>n</mi></msqrt></mfrac><munderover><mo>&sum;</mo><mrow><mi>i</mi><mo>=</mo><mn>1</mn></mrow><mo>&infin;</mo></munderover><mfrac><mrow><msub><mn>x</mn><mn>i</mn></msub><mo>-</mo><mn>&mu;</mn></mrow><mn>&sigma;</mn></mfrac></math> tends for <i>n</i>&rarr;&infin; in distribution to the standard normal distribution <i>N</i>(0,1). For illustration purposes, the <i>X<sub>i</sub></i> are replaced by simulated random numbers for the selected distribution. The relative frequencies of the <i>Y<sub>n</sub></i> values determined for this are displayed; they quickly approach the density of <i>N</i>(0,1)</i>.";
